...
# Файл конфигурации .version-stamper
...
## Немного о перехватчиках git (git hooks)
...
## Обзор структуры каталогов репозитория git
