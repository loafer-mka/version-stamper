...
```
  ...
  эти сведения возвращает `git describe`. Код версии 0102014D - 32-х
  битовое число, содержащее в старшем байте старшийномер версии, в следующем
  байте - младший номер, а в младшем 16-ти битовом слове - номер сборки.
  ...
  на основе имени пользователя и стандартной конфигурации в файле параметров
  `version-stamper-config`.
...
должно быть указано имя плагина. Проще всего взять за основу любой
существующий плагин и внести в него необходимые изменения.
